...
; settings/logs (%APPDATA%\rag-vault) and the DEFAULT vault folder
...
!macro customUnInstall
  MessageBox MB_YESNO|MB_ICONQUESTION|MB_DEFBUTTON2 \
    ...
    ; Electron derives userData from package.json "name" ("rag-vault"), not the
    ; electron-builder productName, so the app's settings/logs live there.
    RMDir /r "$APPDATA\rag-vault"
