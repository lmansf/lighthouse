/**
 * Evidence-pack export for Beam analytics answers
 ...
 * SVG, the exact SQL, and file provenance + freshness. Everything in a pack
 * is already on the answer — this module
 ...
 * packs, Notes/transcripts) into one self-contained HTML string
